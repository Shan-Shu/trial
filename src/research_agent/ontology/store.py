...
RELATION_SYNONYMS = {
    ...
    "lead to": "causes", "leads to": "causes", "promote": "causes",
    "promotes": "causes", "enhance": "causes", "enhances": "causes",
    "induce": "causes", "induces": "causes", "facilitates": "causes",
    "contributes to": "causes", "upregulates": "causes",
